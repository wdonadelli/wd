		...
		text: {
			value: function(x, y, text, point) {
				...
				const config = {
					...
					vsw: {x: -y, y: x, "text-anchor": "start",  "dominant-baseline": "ideographic", transform: "rotate(270)"},
					...
					vs:  {x: -y, y: x, "text-anchor": "middle", "dominant-baseline": "ideographic", transform: "rotate(270)"},
					...
					vse: {x: -y, y: x, "text-anchor": "end",    "dominant-baseline": "ideographic", transform: "rotate(270)"},
				};
